...
// 1) PEGÁ AQUÍ TU CONFIGURACIÓN DE FIREBASE
//    (la conseguís en el paso 3 del instructivo)
...
// 3) LISTA DE ALUMNOS (ya están cargados, podés editar)
const ALUMNOS_E1 = ["Felipe Montero","Emmanuel Druard Rodríguez","Juan Inti Faversani Sueldo","Lautaro Alvarez","Martín"];
